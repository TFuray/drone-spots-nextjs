...
const SpotPage = async ({ params }: Props) => {
  ...
  console.log(decodeURI(params.spotTitle))
  const spotTitle = decodeURI(params.spotTitle)

  const spot = await prisma.spot.findFirst({
    where: { title: spotTitle }
  })
  console.log(spot)
        ...
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-wrap -m-12'>
            <div className='p-12 md:w-1/2 flex flex-col items-start'>
              ...
              {spot && <Image src={spot.imageUrl} alt="" width={500} height={500} />}
              <p className='leading-relaxed mb-8'>{spot?.description}</p>
